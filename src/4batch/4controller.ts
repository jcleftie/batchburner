...
import { getServers, copyScripts, checkTarget, isPrepped, prep, Deque } from '@utils4';

const TYPES = ['hack', 'weaken1', 'grow', 'weaken2'];
const WORKERS = ['/part4/tHack.js', '/part4/tWeaken.js', '/part4/tGrow.js'];
const SCRIPTS = {
  hack: '/part4/tHack.js',
  weaken1: '/part4/tWeaken.js',
  grow: '/part4/tGrow.js',
  weaken2: '/part4/tWeaken.js',
};
  ...
  log() {
    ...
    ns.print(
      `Hacking ~\$${ns.formatNumber(
        ((metrics.maxMoney * metrics.greed * metrics.chance) / (4 * metrics.spacer)) * 1000,
